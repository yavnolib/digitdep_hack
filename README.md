...
Важно не только соблюсти ограничения, но и сформировать лоты так, чтобы поставщикам было удобно их поставлять. Исходя из всего вышеперечисленного был предложен следующий алгоритм автоматического лотирования:
